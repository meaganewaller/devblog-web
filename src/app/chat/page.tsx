      ...
      <InnerSection>
        <div className='p-2'>
          <div className='relative mx-auto my-0 w-full'>
            <h2 className='w-full text-center font-venice text-3xl font-light text-accent-dark'>Send a message</h2>
            <div className='p-[2em] pt-[1.25em]'>
              <p className='text-justify font-extra font-light text-primary-txt'>
                Hey there! I'm thrilled that you want to get in touch. Whether you have questions, ideas, or just want
                to say hi, I'd love to hear from you.
              </p>
              <h3 className='mt-[1.5em]'>Have a Question?</h3>
              <p className='text-justify font-extra font-light text-primary-txt'>
                If you're curious about anything--from my journey in the tech world to the latest blog post--feel free
                to ask. No question is too big or small, and I'll do my best to (eventually) provide an insightful
                answer.
              </p>
              ...
              <p className='text-justify font-extra font-light text-primary-txt'>
                ...
                better? I'm all ear! Your input helps shape the content I prioritize and create.
              </p>
