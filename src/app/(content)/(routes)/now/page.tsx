    ...
    <Section>
      <InnerSection>
        ...
        <ul>
          ...
          <li>
            <strong>Work:</strong> Senior Dev Consultant @{" "}
            <Link href="https://testdouble.com">Test Double</Link>
          </li>
          <li>
            <strong>Interests:</strong> Personal Knowledge Management, Pilates,
            and Taylor Swift are occupying my brain.
          </li>
          <li>
            <strong>Family:</strong> Getting married in 2024!
          </li>
          <li>
            <strong>Reading:</strong> Not much right now. I'm in a bit of a
            reading slump.
          </li>
          <li>
            <strong>Watching:</strong> The Challenge: All Stars, RuPaul's Drag
            Race, and Survivor is about to start back up!
          </li>
          <li>
            <strong>Listening:</strong> Putting{" "}
            <Link href="https://music.apple.com/us/playlist/girlhood/pl.u-kv9lGZ5TX1DmAx">
              this playlist
            </Link>{" "}
            on frequently.
          </li>
          <li>
            <strong>Personal Projects:</strong> Wedding planning,{" "}
            <Link href="/blog">blogging</Link>, and not much else!
          </li>
        </ul>
      </InnerSection>
    </Section>
