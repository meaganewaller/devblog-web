      ...
      <InnerSection>
        ...
        <div>
          <p className="mx-auto mb-10 w-5/6 text-justify">
            Hey there! Got questions, ideas, or just wanna chat? Whether you're
            curious about tech, have blog suggestions, or share common
            interests, I'm all ears. Connect on social for updates, drop your
            deets below, and let's keep the convo rollin'! 🚀
          </p>
          {success && (
            <div
            ...
            >
              <HiCheckCircle
                className="mr-2 h-5 w-5 text-vibrant-green"
                aria-hidden="true"
              />
              <span className="sr-only">Success</span>
              <div>
                <span className="font-medium">Success!</span> Your message has
                been sent, I will get back to you soon!
              </div>
              <HiX
          ...
          {error && (
            ...
            >
              <HiExclamationCircle
                className="mr-2 h-5 w-5 text-raspberry-pink"
                aria-hidden="true"
              />
              <span className="sr-only">Error</span>
              <div>
                <span className="font-medium">Error!</span> Your message could
