        ...
        <Section>
              ...
              <div className='relative z-[2] mb-[25px] mt-0'>
                <div className='relative overflow-hidden rounded-md'>
                  ...
                  <div className='absolute left-[30px] right-0 top-[30px] z-10 block w-full'>
                    <CategoryLink href={`/blog/category/${post?.category?.slug}`}>{post?.category?.title}</CategoryLink>
                  </div>
                </div>
              </div>
              <PostMeta>
                <Link href='/meagan' title='Meagan Waller' className='mr-5 align-middle'>
                  ...
                  <span className='inline-block align-middle font-mono text-xs'>Meagan Waller</span>
                </Link>
          ...
          <section className='relative z-1 mt-[70px] rounded-lg bg-toolbar pb-[20px] pl-[20px] pr-[20px] pt-[30px] text-center text-on-accent'>
            ...
            <div className='mx-auto my-0 text-sm'>
              <h4 className='mb-[20px] mt-[35px] text-lg leading-loose text-on-accent'>Meagan Waller</h4>
              <p className='mb-[20px] leading-loose'>
                I wrote my first line of HTML on Microsoft Notepad in 2004 and fell head-over-heels for how magical it
                all felt. The problem I was solving in 2004? My Neopets shop page wasn&apos;t pretty enough. I was 12
                years old.
              </p>
              <div className='mt-[15px]'>
                <Link href='#' className='mx-3 my-0 inline-block text-lg text-on-accent'>
