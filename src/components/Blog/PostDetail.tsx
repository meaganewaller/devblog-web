...
//   block clear-both overflow-hidden px-16 pt-0 pb-12 m-0 tracking-wide align-baseline break-words border-l-0
// lg:border-r border-solid border-y-0 border-accent text-primary-txt lg:float-left lg:w-2/3
...
inline-block py-1 px-6 mt-0 mr-1 mb-1 ml-0 font-sans text-sm font-semibold tracking-wide leading-7 text-left
text-on-accent align-top break-words bg-accent border-0 cursor-pointer hover:bg-accent-dark rounded-lg
`
