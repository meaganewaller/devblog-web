...
import { FaChevronDown, FaChevronRight, FaLeaf, FaRss, FaStar } from 'react-icons/fa'
...
const BlogCallout = () => {
  ...
  return (
    <div className='bg-yellow-200 rounded leading-5'>
      ...
      <div className={tw('flex flex-row items-center p-4 md:space-x-4', expanded ? '' : 'hidden')}>
