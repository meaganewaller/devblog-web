...
export const FeaturingMini = () => (
  <div className="mt-8 sm:hidden">
    <p>
      Currently showing{" "}
      <span className="text-xl font-bold text-sky-blue">Highlights</span>
      <div></div>
    </p>
    <p></p>
  </div>
...
const Featuring = () => (
  <div>
    ...
    <div className="space-y-1">
      ...
      >
        <Image
          src="/static/images/ui/29.svg"
          width={40}
          height={40}
          alt="Highlights"
        />
        <div className="flex flex-col">
          <span className="text-xl font-bold text-deep-sky-blue group-hover:italic">
            Gems
          </span>
          <span className="font-semibold text-espresso group-hover:italic">
            The crème de la crème of the content.
          </span>
        </div>
      </Link>
      ...
      >
        <Image
          src="/static/images/ui/notepad.svg"
          width={40}
          height={40}
          alt="Archive"
        ></Image>
