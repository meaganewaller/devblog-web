      ...
      <div className='mx-auto w-full max-w-3xl'>
        <div className='grid grid-cols-1 justify-items-center gap-24'>
          <div className='mx-auto px-2'>
            ...
            <form onSubmit={subscribe} className='grid w-full grid-cols-1 gap-6'>
              <div className='font-extra'>
                <p className='mb-4 text-md italic text-lilac last:mb-0'>
                  Twice-monthly<span className='font-bold'>ish</span> doses straight to your inbox. Featuring the latest
                  blog posts, web gems I've stumbled upon, side projects that may or may not see the light of day, my
                  ongoing tinkerings, and whatever current hyper-focus that's consuming my existence.
                </p>
              </div>
              <div className='mx-auto mb-2 grid grid-cols-1 gap-2'>
                <div className='relative flex h-10 w-full min-w-[200px] max-w-[24rem] font-extra'>
                  ...
                  <button
                    type='submit'
                    className='!absolute right-1 top-1 z-10 select-none rounded bg-lilac px-4 py-2 text-center align-middle font-sans text-xs font-bold uppercase text-electric-purple shadow-md shadow-purple/60 transition-all hover:shadow-lg hover:shadow-purple/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none peer-placeholder-shown:pointer-events-none peer-placeholder-shown:bg-accent/50 peer-placeholder-shown:bg-background peer-placeholder-shown:opacity-50 peer-placeholder-shown:shadow-none'
