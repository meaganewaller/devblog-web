      ...
      <div className='relative z-10 bg-[#78ab5e]'>
        <div className='mx-auto max-w-7xl px-6 pb-8 lg:px-8'>
          <div className='md:flex md:items-center md:justify-between'>
            <div>
              <div className='mb-4'>
                <h3 className='text-gray-900 text-sm font-semibold leading-6'>Subscribe to new posts</h3>
                <p className='text-gray-800 text-sm leading-6'>Twice a month on average. Seriously, that's it.</p>
              </div>
              <form
            ...
            <div className='flex justify-center space-x-6 md:order-2 md:justify-end'>
              {navigation.social.map((item) => (
                <a key={item.name} href={item.href} className='text-green-50 hover:text-green-200'>
                  ...
                  <item.icon className='fill-gray-900 hover:fill-green-800  h-6 w-6' aria-hidden='true' />
                </a>
              ))}
            </div>
