...
export default function NewsletterForm({
  ...
  return (
    <section className="flex flex-col items-center justify-center">
      <p className="my-4 text-xl font-normal tracking-tight text-accent md:text-3xl lg:text-4xl">
        {title}
      </p>

      <p className="my-1 max-w-4xl text-md text-espresso md:text-lg lg:text-2xl">
        {subtitle}
      </p>
