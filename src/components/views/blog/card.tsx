...
export const BlogCard = ({ post, category }: Props) => {
  return (
    ...
    >
      ...
      <h3 className='text-neutral-dark mb-2.5 p-2 text-lg font-bold leading-tight tracking-[1px]'>{post.title}</h3>
      <div className='card-content mb-10 p-2'>
        <p className='text-text mb-2.5 break-words text-start text-base leading-normal'>{post.description}</p>
      </div>
      <div
