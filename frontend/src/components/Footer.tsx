...
import { SubscribeSize } from '@/types'
import siteMetadata from '@/data/siteMetadata'
import {usePushFooterToBottom } from "@/hooks/pushFooterToBottom"
...
export const Footer = () => {
  const footerHeight = usePushFooterToBottom();

  return (
    <div className={`mt-[${footerHeight}px]`}>
