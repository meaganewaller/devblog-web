    ...
    <Draggable nodeRef={windowRef} onMouseDown={sendElementToTop}>
      ...
      >
        <div className="col-start-2 col-end-3 row-start-1 row-end-2 flex items-center select-none mr-[1px] handle">
          ...
          <div className="flex flex-1 items-center font-bold text-text before:content-[''] after:flex-1 before:flex-1 after:h-[12px] before:h-[12px] after:bg-windowTitleBar before:bg-windowTitleBar after:mx-[5px] before:mx-[5px]">
            {title}
          </div>
