  ...
  return (
    <Layout>
      ...
      <div className="px-2 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 font-extra">
        {posts.map((post) => (
          <div className="max-w-[300px] bg-primary-lightest-100 dark:bg-accent-first-dark-500 shadow-[10px_10px] shadow-primary-200 dark:shadow-accent-first-900 pb-4">
            <Image src="https://placekitten.com/600/300" width={600} height={300} alt={post.title} />
            <h2 className="dark:text-accent-first-light-300 text-primary-300 pt-4 px-4 font-bold">{post.title}</h2>
            <p className="dark:text-accent-first-light-200 text-primary-dark-400 px-4 line-clamp-3">{post.description}</p>
          </div>
        ))}
      </div>
    </Layout>
