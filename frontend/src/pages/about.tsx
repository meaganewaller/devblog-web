          ...
          <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div className="flex flex-col lg:flex-row justify-between gap-8">
              <div className="w-full lg:w-10/12 flex flex-col justify-center font-extra">
                <h1 className="text-2xl lg:text-3xl font-venice leading-9 text-primary-three pb-4 capitalize tracking-wide p-1 text-center before:content-[url('/static/images/ui/leftsparkle.gif')] before:pr-[5px] after:content-[url('/static/images/ui/leftsparkle.gif')] after:pl-[5px]">
                  About
                </h1>
                <ul className="list-flower w-full list-inside py-0 px-[5px] my-0 mx-[15px] text-base text-tertiary-three">
                  <li className="p-[2px]">
                  ...
                  <li className="p-[2px]">
                    ...
                    <Link href="https://testdouble.com" className="bg-tertiary-three text-white p-1 hover:bg-tertiary-two" target="_blank">
                      test double
                    </Link>
                  </li>
                  <li className="p-[2px]">
