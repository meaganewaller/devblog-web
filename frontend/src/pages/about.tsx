          ...
          <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div className="flex flex-col lg:flex-row justify-between gap-8">
              <div className="w-full lg:w-10/12 flex flex-col justify-center">
                <h1 className="text-2xl lg:text-3xl font-extra leading-9 text-primary-dark-400 dark:text-accent-first-light-300 pb-4 uppercase tracking-wide p-1 text-center before:content-[url('/static/images/ui/leftsparkle.gif')] before:pr-[5px] after:content-[url('/static/images/ui/leftsparkle.gif')] after:pl-[5px]">About</h1>
                <ul className="list-flower w-full list-inside py-0 px-[5px] my-0 mx-[15px] text-base">
                  <li className="p-[2px]">
                    <strong className="w-1/4 md:w-1/3 inline-block">name:</strong>
                    meagan
                  </li>
                  <li className="p-[2px]">
                    <strong className="w-1/4 md:w-1/3 inline-block">location:</strong>
                    northeast florida
                  </li>
                  <li className="p-[2px]">
                    <strong className="w-1/4 md:w-1/3 inline-block">title:</strong>
                    senior dev consultant @ <Link href="https://testdouble.com" target="_blank">test double</Link>
                  </li>
                  <li className="p-[2px]">
                    <strong className="w-1/4 md:w-1/3 inline-block">sign:</strong>
                    aries ☼ / aquarius ☽ / taurus ↑
                  </li>
                  <li className="p-[2px]">
                    <strong className="w-1/4 md:w-1/3 inline-block">languages:</strong>
                    ruby, typescript, lua
                  </li>
                  <li className="p-[2px]">
                    <strong className="w-1/4 md:w-1/3 inline-block">contact:</strong>
                    meagan [at] meaganwaller.com
                  </li>
                </ul>
              </div>
              <div className="w-full lg:w-8/12">
                <Image src="/static/images/avatar.svg" alt="Meagan Waller" width={250} height={250} className="w-full h-full" priority />
              </div>
            </div>
            <h1 className="text-lg font-extra text-center uppercase tracking-wide px-5 pb-1 pt-5 before:content-[url('/static/images/ui/leftsparkle.gif')] before:pr-[5px] after:content-[url('/static/images/ui/leftsparkle.gif')] after:pl-[5px]">Quickly</h1>
            ...
            <h1 className="font-extra text-lg uppercase tracking-wide px-5 pb-1 pt-5 text-center before:content-[url('/static/images/ui/leftsparkle.gif')] before:pr-[5px] after:content-[url('/static/images/ui/leftsparkle.gif')] after:pl-[5px]">A Bit More</h1>
            <p className="text-base text-justify p-5 pt-2">
