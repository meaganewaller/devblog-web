                    ...
                    <div className="mt-6 sm:mt-0 sm:mb-12">
                      <div className="flex flex-col sm:flex-row items-center">
                        <div className="flex justify-start w-full mx-auto items-center">
                          <div className="w-full sm:w-1/2 sm:pr-8">
                            <div className="p-4 dark:bg-accent-first-500 bg-primary-500 dark:text-accent-first-lighter-100 text-primary-lightest-100 rounded shadow">
                              <h2 className="text-sm font-mono tracking-wide font-semibold">{chunk[0].role}</h2>
                              {chunk[0].company && (<h3 className="text-xs font-mono">{chunk[0].company}</h3>)}
                              <p>{chunk[0].description}</p>
                              <Link href="#" className="py-2 px-3 dark:bg-accent-first-800 bg-primary-light-100 text-primary-500 rounded-sm">Read more</Link>
                              <span className="text-xs inline-block">{chunk[0].dates}</span>
                            </div>
                          </div>
                        </div>
                        <div className="rounded-full dark:bg-accent-first-light-500 bg-primary-light-500 border-primary-500 dark:border-accent-first-500 border-2 w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                          <Image src="/static/images/emojis/computer.gif" width={21} height={18} alt="Pink pixel art computer" />
                        </div>
                      </div>
                    </div>
                    {chunk[1] && (
                        ...
                        <div className="flex flex-col sm:flex-row items-center">
                          <div className="flex justify-end w-full mx-auto items-center">
                            <div className="w-full sm:w-1/2 sm:pl-8">
                              <div className="p-4 dark:bg-accent-first-500 bg-primary-500 dark:text-accent-first-lighter-100 text-primary-lightest-100 rounded shadow">
                                <h2 className="text-sm font-mono tracking-wide">{chunk[1].role}</h2>
                                {chunk[1].company && (<h3 className="text-xs font-mono">{chunk[1].company}</h3>)}
                                <p>{chunk[1].description}</p>
                                <Link href="#" className="py-2 px-3 dark:bg-accent-first-800 bg-primary-light-100 text-primary-500 rounded-sm">Read more</Link>
                                <span className="text-xs inline-block">{chunk[1].dates}</span>
                              </div>
                            </div>
                          </div>
                          <div className="rounded-full dark:bg-accent-first-light-500 bg-primary-light-500 border-primary-500 dark:border-accent-first-500 border-2 w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
