    ...
    <>
      ...
      >
        <div className="col-start-2 col-end-3 row-start-1 row-end-2 flex items-center select-none mr-[1px] handle">
          ...
          <div className="flex flex-1 items-center font-bold text-primary before:content-[''] after:flex-1 before:flex-1 after:h-[12px] before:h-[12px] after:bg-windowTitleBar before:bg-windowTitleBar after:mx-[5px] before:mx-[5px]">
            {title}
          </div>
        ...
        <div className="col-start-2 col-end-3 row-start-2 row-end-3 bg-white h-full border border-solid border-primary-darker-800 dark:border-accent-first-darker-900 shadow-[1px_1px_0_#fff_-1px_-1px_0_#9c9c9c] overflow-x-hidden overflow-y-auto">
          {children}
        </div>
